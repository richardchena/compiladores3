...
void insertTablaSimbolos(const char *s, char *c, int n){
	entrada e;
	strcpy(e.lexema,s);
	strcpy(e.componenteLexico,c);
	e.compLex=n;
	insertar(e);
}

void initTablaSimbolos(){
	insertTablaSimbolos("[",        "L_CORCHETE",   L_CORCHETE);
	insertTablaSimbolos("]",        "R_CORCHETE",   R_CORCHETE);
    insertTablaSimbolos(",",        "COMA",         COMA);
	insertTablaSimbolos(":",        "DOS_PUNTOS",   DOS_PUNTOS);
	insertTablaSimbolos("{",        "L_LLAVE",      L_LLAVE);
	insertTablaSimbolos("}",        "R_LLAVE",      R_LLAVE);
	insertTablaSimbolos("true",     "PR_TRUE",      PR_TRUE);
	insertTablaSimbolos("TRUE",     "PR_TRUE",      PR_TRUE);
	insertTablaSimbolos("false",    "PR_FALSE",     PR_FALSE);
	insertTablaSimbolos("FALSE",    "PR_FALSE",     PR_FALSE);
	insertTablaSimbolos("null",     "PR_NULL",      PR_NULL);
	insertTablaSimbolos("NULL",     "PR_NULL",      PR_NULL);
}